...
import { Avatar, Card, CardActions, CardContent, CardHeader, CardMedia, Collapse, Container, IconButton, styled } from '@mui/material';
    ...
    return (
        <Tag.Contain>
            {favoriteRecipes.map((favorite, index) => {
                return (
                    <Card key={index} sx={{ maxWidth: 345, maxHeight: 'auto' }}>
                        <CardHeader
                            avatar={
